 ...
 *
 * Modifications added in 2021 by Paul Batchelor
 *
...
/* Paul: addeded loader callback */
static int repl(void (*loader)(lil_t), void (*clean)(lil_t))
{
    char buffer[16384];
    lil_t lil = lil_new();
